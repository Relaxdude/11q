...
def weekly_window():
	...
	Label(frame_up, text="Понедельник", font=("Arial", 16), bg= color_grey).place(x=35, y=0, height=40, width= 234)
	Label(frame_up, text="Вторник", font=("Arial", 16), bg= color_grey).place(x=297, y=0, height=40, width= 234)
	Label(frame_up, text="Среда", font=("Arial", 16), bg= color_grey).place(x=559, y=0, height=40, width= 234)
	Label(frame_up, text="Четверг", font=("Arial", 16), bg= color_grey).place(x=821, y=0, height=40, width= 234)
	Label(frame_up, text="Пятница", font=("Arial", 16), bg= color_grey).place(x=1083, y=0, height=40, width= 234)
	Label(frame_up, text="Суббота", font=("Arial", 16), bg= color_grey).place(x=1345, y=0, height=40, width= 234)
	Label(frame_up, text="Воскресенье", font=("Arial", 16), bg= color_grey).place(x=1607, y=0, height=40, width= 234)
