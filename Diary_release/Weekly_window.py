...
def state_or_normal(status_task):
	if int(status_task[5]) == -2 or int(status_task[5]) == -1 or int(status_task[5]) == 1:
		return 'disabled'
	else:
		return 'normal'
...
def weekly_window():
	...
	Button_to_Main.place(x=71, y=20, height=80, width= 286)
	...
	Button_Add.place(x=428, y=20, height=80, width= 286)
	...
	Button_close.place(x=785, y=20, height=80, width= 286)
	...
	Button_week_1.place(x=1142, y=20, height=80, width= 286)
	...
	Button_week_2.place(x=1499, y=20, height=80, width= 286)
